    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CoderCampsCRM.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(CoderCampsCRM.Models.ApplicationDbContext context)
        {
            ...
            UserTask[] tasks = new UserTask[] {
                ...
                new UserTask {Id = 4,
                    Status = "Completed",
                    Description = "Schedule Meeting for Lunch",
                    DueDate = "05/19/2016",
                    StartDate = "02/10/2016",
                    Type ="Email",
                    ContactId= 5},
                new UserTask {Id = 5,
                    Status = "Completed",
                    Description = "Meet with Coder Camps group at 9AM",
                    DueDate = "02/18/2016",
                ...
                new UserTask {Id = 3,
                    Status = "In Progress",
                    Description = "Complete Individual Project for Coder Camps",
                    DueDate = "02/26/2016",
                    StartDate = "02/17/2016",
                    Type ="Project",
                    ContactId= 7},
                new UserTask {Id = 4,
                    Status = "Completed",
                    Description = "Complete Group Project",
                    DueDate = "02/26/2016",
                    StartDate = "02/10/2016",
                    Type ="Project",
                    ContactId= 8},
                new UserTask {Id = 5,
                    Status = "Completed",
                    Description = "Submit Resume for Hire",
                    DueDate = "03/1/2016",
                    StartDate = "02/17/2016",
                    Type ="Phonecall",
                    ContactId= 9}
