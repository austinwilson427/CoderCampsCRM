...
//        public getCompany() {
//            this.companyService.getDealByDealId(this.routeId).$promise.then((result) => {
...
//            this.companyLogItemService.listCompanyLogItemsByDealId(this.routeId).$promise.then((result) => {
...
//        public getCompany() {
//            this.companyService.getCompanyByCompanyId(this.routeId).$promise.then((result) => {
//                this.companyInfo = result;
//            });
//        }
...
//        public getCompany() {
//            this.companyService.getCompanyByCompanId(this.routeId).$promise.then((result) => {
//                this.companInfo = result;
//            });
//        }
...
//    export class CompanInfoTaskController {
